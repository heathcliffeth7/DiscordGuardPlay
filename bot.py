...
def load_security_settings():
    ...
    try:
        ...
        # Regex Settings - DEVRE DIŞI: load_settings() zaten bot_settings.json'dan yüklüyor
        # Bu blok load_settings()'ten sonra çağrıldığı için regex kurallarını siliyordu
...
def _collect_regex_text_blocks(
    ...
    *,
    ...
    # Embed taramayı devre dışı bırak - sadece mesaj içeriği taransın
    ...
    # Yanıtlanan mesajı taramayı devre dışı bırak - sadece yanıtın kendisi taransın
